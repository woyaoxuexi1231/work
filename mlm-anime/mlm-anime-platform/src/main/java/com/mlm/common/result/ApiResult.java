 ...
 * 统一 API 响应结果封装。
 * <p>
 * 所有 REST 接口使用此类作为统一响应体，确保前端可以按固定结构解析：
 * <pre>
...
public class ApiResult<T> {
    ...
    /** 业务状态码，供前端做程序化判断（如 SUCCESS / SCRIPT_SUBMITTED） */
     ...
     * 构造失败响应。
     *
     * @param code    HTTP 语义状态码（400/404/500）
     * @param message 错误描述
     * @param <T>     数据类型
     * @return 失败响应
     */
