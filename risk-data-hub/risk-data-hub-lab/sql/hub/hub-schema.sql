...
(
    ...
    fetch_finished_at           TIMESTAMP(3) NULL COMMENT '拉取完成',
    fetch_queued_at             TIMESTAMP(3) NULL COMMENT '入队时间',
    fetch_queued_finished_at    TIMESTAMP(3) NULL COMMENT '出队时间',
    ...
    existing_query_started_at   TIMESTAMP(3) NULL COMMENT '查询已存在记录开始',
    existing_query_finished_at  TIMESTAMP(3) NULL COMMENT '查询已存在记录完成',
    split_started_at            TIMESTAMP(3) NULL COMMENT '数据分流开始',
    split_finished_at           TIMESTAMP(3) NULL COMMENT '数据分流完成',
