...
| 天   | 主题                                      | 覆盖原理编号   | 完成情况 |
| ---- | ----------------------------------------- | -------------- | -------- |
| 1    | 手写动态数组与 fail-fast                  | 5, 29          | ✅ 80%    |
| 2    | 手写 HashMap 基本版（数组+链表）          | 1, 2           | ✅ 80%    |
| 3    | HashMap 树化与退化完整实现                | 3, 1           | ✅80%     |
| 4    | LinkedHashMap 与 LRU 缓存                 | 8              | ✅80%     |
| 5    | TreeMap 与红黑树平衡探究                  | 7              | ✅80%     |
| 6    | ConcurrentHashMap 源码探针（1.8）         | 4              | ✅80%     |
| 7    | ArrayList 源码攻防与扩容微基准            | 5, 29          | ✅80%     |
| 8    | synchronized 锁升级实验（JOL 观察对象头） | 9              | ✅80%     |
| 9    | volatile 与 DCL 正确/错误版本对比         | 10             | ✅80%     |
| 10   | AQS 自实现与 ReentrantLock 探针           | 11, 12         | ✅80%     |
| 11   | 线程池源码级实验 + 自定义拒绝策略         | 13             | ✅80%     |
| 12   | ThreadLocal 内存泄漏复现与分析            | 14             | ✅80%     |
| 13   | CAS 实战：无锁栈 + ABA 复现与解决         | 15             | ✅80%     |
| 14   | 三大并发工具 CountDownLatch 等底层追踪    | 16             | ✅80%     |
